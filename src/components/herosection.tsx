...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/asset/sofa.png", // Replace with the correct path
    lampImage: "/asset/lamp.png", // Replace with the correct path
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/asset/sofa.png", // Replace with another chair image
    lampImage: "/asset/lamp.png", // Replace with another lamp image
  },
  {
...
function HeroSection() {
  ...
  return (
    <section className="relative bg-purple py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      {/* Left Column: Lamp */}
